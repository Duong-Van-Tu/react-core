  ...
  return (
    <ModalContext.Provider value={{ openModal, closeModal }}>
      ...
      <Modal open={open} onCancel={closeModal} footer={null}>
        ...
        {currentModal === ModalPrivilegesType.SuggestedEdit && <div>Set KPI Modal</div>}
        {currentModal === ModalPrivilegesType.Evaluation && <div>Evaluation Modal</div>}
        ...
        {currentModal === ModalPrivilegesType.UpdateResults && <div>UpdateResults Modal</div>}
        {currentModal === ModalPrivilegesType.ProposedReports && <div>ProposedReports Modal</div>}
      </Modal>
